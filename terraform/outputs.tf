...
output "user" {
  ...
  description = "The IAM user being created to test the cisagov/ansible-assessor-portal Ansible role."
}

output "user_access_key" {
  value       = aws_iam_access_key.key
  description = "The access key for the IAM user being created to test the cisagov/ansible-assessor-portal Ansible role."
  sensitive   = true
}
